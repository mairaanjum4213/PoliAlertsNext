      ...
      <section className="font-Manrope flex flex-col justify-center items-center my-16">
        <div className="xl:w-[35%] lg:w-[40%] md:w-[50%] w-[90%] rounded-xl mx-auto bg-lightGray">
          <div className="md:p-16 p-10">
            <h1 className="md:text-4xl text-xl font-bold mb-4 text-headingColor">
              Log in
            </h1>
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <Link
                  className="text-blueColor underline font-semibold w-fit text-sm hover:no-underline hover:text-blueHover"
                  href="/"
                >
                  Forgot Password?
                </Link>
